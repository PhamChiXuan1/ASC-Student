...
const data = [
  ...
  function ManXemDiem_TKHK({navigation}) {
    return (
      <View style={styles.container}>
        ...
        <View style={styles.topContent}>
            <TouchableOpacity style={styles.oTopContent1} onPress={()=>{navigation.navigate('ManXemDiem_TongQuan')}}>
            ...
            <TouchableOpacity style={styles.oTopContent3} onPress={()=>{navigation.navigate('ManXemDiem_ChiTiet')}}>
        ...
        <View style={styles.content}>
          <FlatList
            ...
            renderItem={({item})=>{
                return(
                    <View style={{flexDirection: 'column', left: '20px', borderBottomWidth:'1px', borderBottomColor: 'gray', marginRight: '40px', marginBottom: '20px'}}>
                        <Text style={{color: 'blue', fontWeight: 'bold'}}>{item.tenHocKy}</Text>
