...
const dataMonHoc=[
  ...
  function ManXemDiem_ChiTiet({navigation}) {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.topContent}>
            ...
            <TouchableOpacity style={styles.oTopContent2} onPress={()=>{navigation.navigate('ManXemDiem_TKHK')}}>
                ...
                return(
                    <View style={{margin: '10px',width: '330px'}}>
                        <TouchableOpacity
                          ...
                          style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', height: '50px', width: '330px'}}>
